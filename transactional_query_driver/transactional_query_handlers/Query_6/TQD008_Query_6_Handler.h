...
Description:
    Header file for the query handler of the transactional query type 6
*/
#include "../../../configuration/QDC001_TQD_Config.h"
#include "../../../utils/QDU001_Time.h"
#include "../../../utils/QDU002_Random.h"

#ifndef TQD008_QUERY_6_HANDLER_H
#define TQD008_QUERY_6_HANDLER_H
...
namespace TQ_6 {
  ...
  struct output_struct {
    uint64_t start_time;
    uint64_t end_time;
    unsigned long friend_trade_list_length;
    unsigned long* friend_trade_list_pointer;
    bool success;
  };
