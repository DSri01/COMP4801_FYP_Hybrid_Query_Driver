...
Description:
    Header file for the query handler of the analytical query type 2
*/
#include "../../../configuration/QDC002_AQD_Config.h"
#include "../../../utils/QDU001_Time.h"

#ifndef AQD003_QUERY_2_HANDLER_H
#define AQD003_QUERY_2_HANDLER_H

namespace AQ_2 {

  // ANALYTICAL QUERY 2: PageRank
