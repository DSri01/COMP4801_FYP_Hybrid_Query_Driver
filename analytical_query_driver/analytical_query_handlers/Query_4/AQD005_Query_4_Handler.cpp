...
Description:
    ...
    query type 4.
*/
#include "AQD005_Query_4_Handler.h"

using namespace AQ_4;

/*
Description:
    Executes analytical query type 4 and returns the output
*/
void AQ_4::operation_handler(struct input_struct* input, struct output_struct* output, struct analytical_driver_config* config){
...
/*
Description:
    Calls the operation handler of query type 4
*/
void AQ_4::perform_operation(struct analytical_driver_config* config, struct output_struct* output, struct input_struct* input) {
